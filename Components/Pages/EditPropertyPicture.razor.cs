...
{
    public partial class EditPropertyPicture
    {
        [Inject]
        ...
        {
            propertyPicture = await RealEstateDBService.GetPropertyPictureById(id:Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await RealEstateDBService.UpdatePropertyPicture(Id, propertyPicture);
